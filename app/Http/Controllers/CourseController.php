...
class CourseController extends Controller
{
    ...
    public function addCourse(Request $request)
    {
    	...
    	if($request->isMethod('post'))
    	{
            ...
            'course_heading'=>'required',
            'course_subheading'=>'required',
            ]);
            ...
            else
            {
                ...
                $course->course_heading=$input['course_heading'];
                $course->course_subheading=$input['course_subheading'];
    ...
    public function editCourse(Request $request, $id)
    {
    	...
    	$EditData=Course::select('courses.id','courses.course_name','courses.status','teachingoptions.option_name','courses.teaching_id','courses.course_heading','courses.course_subheading')
