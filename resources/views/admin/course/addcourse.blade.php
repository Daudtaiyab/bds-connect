                                ...
                                <form action="{{route('addCourse')}}" method="post" enctype="multipart/form-data">
                                  @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="text" class="form-control" id="course_heading"  name="course_heading" placeholder="Password" required value="{{old('course_heading')}}">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="text" class="form-control" id="course_subheading"  name="course_subheading" placeholder="Password" required value="{{old('course_subheading')}}">
