                        ...
                        <div class="registration-form-outer">
                            <div class="login-form">
                             @include('layouts.noftification')
                                <h4>Edit Course</h4>
                                <div class="line"></div>
                                <form action="{{route('editCourse',$EditData->id)}}" method="post" enctype="multipart/form-data">
                                  @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="text" class="form-control" id="course_name"  name="course_name" placeholder="Password" required value="{{$EditData->course_name}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="file" class="form-control" id="course_img"  name="course_img" placeholder="Password">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="text" class="form-control" id="course_heading"  name="course_heading" placeholder="Password" required value="{{$EditData->course_heading}}">
                                              <label for="floatingPassword">Course Heading</label>
                                               <span style="color: red;">{{$errors->first('course_heading')}}</span>
                                            </div>
                                        </div>

                                         <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                              <input type="text" class="form-control" id="course_subheading"  name="course_subheading" placeholder="Password" required value="{{$EditData->course_subheading}}">
                                              <label for="floatingPassword">Course Sub Heading</label>
                                               <span style="color: red;">{{$errors->first('course_subheading')}}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-center align-items-center w-100">
                                        <button type="submit" name="submit" class="button">Update Course</button>
                                    </div>
                                </form>   
                            </div>    
                        </div>
