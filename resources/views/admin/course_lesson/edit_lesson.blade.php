                                ...
                                <form action="{{route('editLesson',$Edit_lesson->id)}}" method="post" enctype="multipart/form-data">
                                  @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" id="div_level1" style="<?php if($Edit_lesson->cat_id==\Config::get('constants.freeVideo') || $Edit_lesson->cat_id==\Config::get('constants.paidVideo')){ echo "display:block;"; } else { echo "display:block;";} ?>">
                                            <div class="form-floating mb-3">
                                        ...
                                        <div class="col-md-6" id="div_lesson_pdf">
                                            <div class="form-floating mb-3">
                                                <input type="file" class="form-control" id="lesson_pdf" name="lesson_pdf" accept=".pdf" placeholder="Upload PDF File" value="{{ old('lesson_pdf') }}">
                                                <label for="lesson_pdf">Lesson PDF</label>
                                                <span style="color: red;">{{ $errors->first('lesson_pdf') }}</span>
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control" id="old_pdf"  name="old_pdf" placeholder="Password" required value="{{$Edit_lesson->lesson_pdf}}">
