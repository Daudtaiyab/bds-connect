...
<div class="sidebar-list">
    <ul>
        ...
        <a href="{{ route('GelallLibrary') }}"
            class="{{ in_array($ActiveRoute, ['addLibrary', 'editLibrary', 'GelallLibrary']) ? 'active' : '' }}">
            <li>
                <i class="flaticon-edit"></i> <span>Course Level Management</span>
            </li>
        </a>

        <a href="{{ route('getallCourse') }}"
            class="{{ in_array($ActiveRoute, ['getallCourse', 'addCourse', 'editCourse']) ? 'active' : '' }}">
            <li>
        ...
        <a href="{{ route('GetallLesson') }}"
            class="{{ in_array($ActiveRoute, ['addLesson', 'editLesson', 'GetallLesson']) ? 'active' : '' }}">
            <li>
        ...
        <a href="{{ route('Registerschool') }}"
            class="{{ in_array($ActiveRoute, ['Registerschool', 'downloadSchool', 'approvedSchool', 'AssignCourseToUser', 'AssignCourseToUserSave']) ? 'active' : '' }}">
            <li>
