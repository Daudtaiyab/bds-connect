                                      ...
                                      @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="display: none;">
                                                <div class="form-floating mb-3">
                                                  <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Password" value="{{old('last_name')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                  <input type="text" class="form-control" id="wifi_address" name="wifi_address" placeholder="Wifi Ip Address" required value='{{getUserIpAddr()}}'>
                                                  <label for="floatingPassword">Wifi Ip Adress</label>
                                                  <span style="color: red;">{{$errors->first('address')}}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center w-100">
                                            ...
                                            <a href="https://bdsconnect.in/"><button type="button" name="submit" class="button">Login</button></a>
                                        </div>
                                    </form>   
                                </div>    
                            </div>
