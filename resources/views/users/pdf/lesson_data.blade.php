<div class="pdf-content">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <p class="mt-2"><b>Note:</b> For full Screen Mode Click on <code><i class="bi bi-three-dots-vertical"></i></code> and choose option <code><i class="bi bi-arrows-move"></i> Enter Full Screen Mode</code> or you can use shortcut <code>Ctrl+Shift+F</code></p>
            <div class="buttons">
