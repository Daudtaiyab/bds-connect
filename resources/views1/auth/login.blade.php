                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-floating mb-3">
                            <input id="email" type="email"
                                ...
                                value="{{ old('email') ?? $login_email }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input id="password" type="password"
                                ...
                                autocomplete="current-password" value="{{ $login_pass }}">
                        ...
                        <div class="">
                            <label>
                                ...
                                Remember me </label>
                            <a href="{{ route('password.request') }}" class="fr">Forget Password</a>
                        </div>


                        <div class="d-flex justify-content-center align-items-center w-100">
                            <button type="submit" name="submit" class="button">Login Now</button>&nbsp;
                            <a href="{{ route('userregister') }}"><button type="button" name="submit"
                                    class="button">Register</button></a>
                        </div>
                    </form>
                </div>
            </div>
