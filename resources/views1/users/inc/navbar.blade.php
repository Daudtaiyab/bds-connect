        ...
        <div class="logout">
            <div class="dropdown options">
              ...
              <ul class="dropdown-menu" aria-labelledby="options">
                ...
                <li style="display: none;"><a class="dropdown-item" href="{{ route('spritesForm') }}" onclick="event.preventDefault();
                ...
                <li style="display: none;"><a class="dropdown-item" href="{{ route('MoreProduct') }}" onclick="event.preventDefault();
