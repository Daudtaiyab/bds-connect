                                ...
                                <div class="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <label for="codeyrockey_{{$coursedata['id']}}">
                                            <input type="checkbox" id="codeyrockey_{{$coursedata['id']}}" class="checkbox" value="{{$coursedata['id']}}" name="courseassign[]" @if(in_array($coursedata['id'],$AssignUserCourse)) {{'checked'}} @endif>
                                            <div class="card">
                                                <div class="card-img">
